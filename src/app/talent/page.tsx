	...
	return (
		<>
			<Hero
				...
				subheading='Grammerhub is commited to providing top-quality talent to help your business succeed. <br />
				Browse out talent listings today and find the perfect tech professional for your company!'
				...
				<section className='flex flex-col lg:gap-[2rem]'>
					{talentMembers.map((member, index) => (
						<div
							...
							<div
								className={`relative w-[300px] sm:w-[500px] h-[400px] lg:h-[500] ${
